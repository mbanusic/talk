...
configure-general-embedLinks-desc = Allow commenters to add a single piece of embedded media to the end of a comment
configure-general-embedLinks-description = Allow commenters to add a single piece of embedded media to the end of a comment 
